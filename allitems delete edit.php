...
die("could not open $mydb");
    ...
    <a href="file:///H|/project_dumps/EKTA/final/admin/itemedit.php?cid=<?php echo $row['i_code']; ?>"><strong>Edit</strong></a> | <a href="file:///H|/project_dumps/EKTA/final/admin/itemdel.php?action=delete&cid=<?php echo $row['i_code']; ?>"><strong>Delete</strong></a>
        </tr>
  <?php
  }
  ?>
